...
- 🎯 Entry points to execute your program using `python -m <my_fastapi_project>` or `$ my_fastapi_project` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/wesleyhuang2014/my-fastapi-project/branch/main/graph/badge.svg?token=my-fastapi-project_token_here)](https://codecov.io/gh/wesleyhuang2014/my-fastapi-project)
[![CI](https://github.com/wesleyhuang2014/my-fastapi-project/actions/workflows/main.yml/badge.svg)](https://github.com/wesleyhuang2014/my-fastapi-project/actions/workflows/main.yml)

Awesome my_fastapi_project created by wesleyhuang2014

## Install

from source
```bash
git clone https://github.com/wesleyhuang2014/my-fastapi-project my_fastapi_project
...
```bash
pip install my_fastapi_project
```

## Executing

```bash
$ my_fastapi_project run --port 8080
```

or

```bash
python -m my_fastapi_project run --port 8080
```

or

```bash
$ uvicorn my_fastapi_project:app
```

## CLI

```bash
❯ my_fastapi_project --help
Usage: my_fastapi_project [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ my_fastapi_project create-user --help
Usage: my_fastapi_project create-user [OPTIONS] USERNAME PASSWORD
...
```bash
my_fastapi_project create-user admin admin --superuser
```
...
Run with `my_fastapi_project run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `my_fastapi_project create-user`.
...
-----------------------------------------------------
my_fastapi_project/__init__.py              4      0   100%
my_fastapi_project/app.py                  16      1    94%
my_fastapi_project/cli.py                  21      0   100%
my_fastapi_project/config.py                5      0   100%
my_fastapi_project/db.py                   10      0   100%
my_fastapi_project/models/__init__.py       0      0   100%
my_fastapi_project/models/content.py       47      1    98%
my_fastapi_project/routes/__init__.py      11      0   100%
my_fastapi_project/routes/content.py       52     25    52%
my_fastapi_project/routes/security.py      15      1    93%
my_fastapi_project/routes/user.py          52     26    50%
my_fastapi_project/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in my_fastapi_project/default.toml.
