...
# WARNING: Ensure imports from `my_fastapi_project` comes after this line
from my_fastapi_project import app, settings, db  # noqa
from my_fastapi_project.cli import create_user, cli  # noqa
